...
<main>
    <div class="main_inner">
        ...
        <div class="text">
            <h4 class="text_title">第１条・基本方針</h4>
            <p>
        ...
        <div class="text">
            <h4 class="text_title">第２条・収取する情報の範囲</h4>
            <p>
        ...
        <div class="text">
            <h4 class="text_title">第３条・利用目的</h4>
            <p>
                本サイトでは、皆様からのお問い合わせやサービスへのお申し込み等を通じて、皆様の氏名、生年月日、住所、電話番号、メールアドレス等の個人情報をご提供いただく場合があります。その場合は、以下に示す利用目的のために、適正に利用するものと致します。
            </p>
        </div>
        <div class="text">
            <h4 class="text_title">第４条・情報管理</h4>
            <p>
                皆様からお預かりした個人情報は、不正アクセス、紛失、漏えい等が起こらないよう、慎重かつ適切に管理します。
            </p>
        </div>
        <div class="text">
        ...
        <div class="text">
            <h4 class="text_title">第６条・内容の変更について</h4>
            <p>
        ...
        <div class="text">
            <h4 class="text_title">損害等の責任について</h4>
            <p>
